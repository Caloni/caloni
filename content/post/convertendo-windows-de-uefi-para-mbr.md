...
Entre as diferentes distros do Linux há uma chamada SystemRescueCD](https://www.system-rescue-cd.org/SystemRescueCd_Homepage) que é cheia dos paranauê para manutenção de micros. Entre eles há uma ferramenta chamada [testdisk. É uma ferramenta simples, interativa e ágil. É ela que deve ser usada para resgatar as partições da máquina após configurar a BIOS para voltar a bootar no modo legacy.
