...
---
. Porém, tive uma agradável surpresa de achar um truque muito sabido que não conhecia, chamado de [tail recursion. Fiz questão de testar nos dois compiladores mais conhecidos e eis o resultado.

#### Recursividade cara

Imagine uma função recursiva que calcula o fatorial e recursivas, que no caso chamam a mesma função n vezes.
