...
<blockquote>_Adendum. A palestra que participamos foi a **"Por que implementar a gestão financeira de TI? Uma abordagem baseada no ITIL, COBIT/VAL IT, e PMBOK"**, e queríamos ter visto a palestra **"Desafio: Como Gerenciar a Geração Y"**, que como pudemos ver não é tarefa fácil, já que essa geração não consegue nem entrar na palestra certa. Veja a grade do evento para mais informações._</blockquote>
