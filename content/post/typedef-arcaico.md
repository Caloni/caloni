...
categories: [ "code" ]
---
 geralmente prima pela excelência em maus exemplos. A [Notação Húngara e o Typedef Arcaico são duas técnicas que, por motivos históricos, são usados a torto e a direito pelos códigos de exemplo.
